        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (int.TryParse(txtGotoLine.Text, out _gotoLineNumber))
            {
                ...
                if (_gotoLineNumber < 0 || _gotoLineNumber >= _maximumLineNumber)
                    err.SetError(txtGotoLine, string.Format(SQL_Extractor_for_Excel.Properties.Resources.GoTo_Error_MustBeInRange, _maximumLineNumber + 1));
                else
                {
            ...
            {
                err.SetError(txtGotoLine, SQL_Extractor_for_Excel.Properties.Resources.GoTo_Error_MustBeNumeric);
            }
        }
