namespace ScintillaNET_FindReplaceDialog
{
    ...
    public partial class FindReplaceDialog : Form
    {
        ...
        private void FindReplaceDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            FindReplace.Scintilla.ClearSelections();
            FindReplace.Scintilla.MarkerDeleteAll(FindReplace.Marker.Index);
        ...
        private void btnFindAll_Click(object sender, EventArgs e)
        {
            ...
            if (rdoRegexF.Checked)
            {
                ...
                {
                    lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_ErrorInRegex + ex.Message;
                    return;
                }
            ...
            lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_TotalFound + foundCount.ToString();
        }
        ...
        private void btnReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_TotalReplaced + foundCount.ToString();
        }
        ...
        private void btnReplacePrevious_Click(object sender, EventArgs e)
        {
            ...
            {
                lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_MatchNotFound;
            }
            else
            {
                ...
                {
                    if (chkSearchSelectionR.Checked)
                        lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_MatchWrappedBeginningSelection;
                    else
                        lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_MatchWrappedBeginningDocument;
                }
        ...
        public void FindPrevious()
        {
            ...
            else
            {
                ...
                {
                    if (chkSearchSelectionF.Checked)
                        lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_MatchWrappedEndSelection;
                    else
                        lblStatus.Text = SQL_Extractor_for_Excel.Properties.Resources.FindReplace_Status_MatchWrappedEndDocument;
                }
